...
\begin{verbatim}
$Id: widgetTools.Rnw,v 1.18 2002/12/18 20:43:00 jhnzhang Exp $
\end{verbatim}
...
screen, \em{list1} and \em{text1} in one row below, and each of the
radio button and check button groups in a separate row further below,
we will need to put them in a list like this:
